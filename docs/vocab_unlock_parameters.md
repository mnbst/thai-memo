...
|---:|---|---|
| 0-99 | 入門テーマ6件、全文体、文法4件 | freeテーマ4件、free文体2件、文法なし |
| 100-299 | 日常系テーマ5件追加、全文法 | freeテーマ4件、free文体2件、文法なし |
| 300-599 | 学校テーマ | freeテーマ4件、free文体2件、文法なし |
| 600-1499 | 文化系テーマ3件。難易度ラベルが中級になる | freeテーマ4件、free文体2件、文法なし |
| 1500以上 | パラメータ追加なし。難易度ラベルが上級になり文長が自然な長さになる | freeテーマ4件、free文体2件、文法なし |
...
free は `estimated_vocab >= 100` でも `FREE_TOPICS` の4件に限定される。
