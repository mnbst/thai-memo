...
// 拒否リストに掛からない。
//
// level の回答は分析にだけ使う。語彙スコア（estimated_vocab）には一切入れない。
// 申告を下限として書いていた頃は、この書き込みの着地が語彙テストより後になると
// 測定値を申告値へ引き戻していた（report() は失敗すると次の起動で再送するので、
// オフラインのオンボーディングでは普通に起きる）。出発点は語彙テストだけが
// 決める。
// =============================================================================
