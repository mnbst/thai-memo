...
_ALWAYS_RULES = [
    ...
    "（×แดดร้อน กลัวผิวเสีย ไม่เป็นไรค่ะ →○รถติดนิดหน่อย ไม่เป็นไรค่ะ）",
    ...
    "（×เคยมาที่นี่ไหม ไปง่ายนะ →○เคยมาที่นี่ไหม มาง่ายนะ）",
...
- 現代の口語で通用する用法だけ。文語・古語・方言の用法しかないなら文脈ごと変える（×เจ้าทางนี้สวย →○เจ้านี้อร่อยกว่าเจ้าอื่น）
...
- 主題を置いたら、後ろの述語が主題の中で起きたことか主題の一部を述べたものか確認する。どちらでもないなら主題を消す（×คลาสนี้ มือถือฉันพัง →○มือถือฉันพัง）
